...
3. For production deployments, set `VITE_API_URL=https://linkvault-backend-only.onrender.com` in `apps/web` and set `CLIENT_URLS=https://linkvaulthelp.netlify.app,http://localhost:5173` in `apps/api`.
